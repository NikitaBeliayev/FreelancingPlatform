...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20240528232915_DbTagsSeed")]
    partial class DbTagsSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Categories.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a65af977-4c65-4665-814c-0106f46059ed"),
                            Title = "ui/ux design"
                        },
                        new
                        {
                            Id = new Guid("153f181b-8351-4e76-9369-70c5992dc688"),
                            Title = "reactjs"
                        },
                        new
                        {
                            Id = new Guid("0310ad4d-2719-4418-a90c-f46ffff81cad"),
                            Title = "angular"
                        },
                        new
                        {
                            Id = new Guid("602ceb55-7748-48e3-9c4f-b92ccbbd04b2"),
                            Title = ".net"
                        },
                        new
                        {
                            Id = new Guid("dbb705b5-20f4-4588-b573-2732c72cb5c7"),
                            Title = "copywriting"
                        },
                        new
                        {
                            Id = new Guid("03622698-9525-489a-bb52-8eb02f7ee537"),
                            Title = "manual quality assurance"
                        },
                        new
                        {
                            Id = new Guid("6b4bea40-57ea-41fc-8754-0197d8a52e9a"),
                            Title = "automation quality assurance"
                        },
                        new
                        {
                            Id = new Guid("20d7d92b-2380-4c0c-9980-b1d995af76db"),
                            Title = "document management"
                        },
                        new
                        {
                            Id = new Guid("39fd83eb-97a4-4add-a921-d9fdf22e6c40"),
                            Title = "content management"
                        },
                        new
                        {
                            Id = new Guid("f83c20ff-ec35-4258-97b7-400e18a64e9a"),
                            Title = "languages"
                        },
                        new
                        {
                            Id = new Guid("a9fd5bad-78ee-4b4e-b274-33dc81bdab06"),
                            Title = "artificial intelligence"
                        },
                        new
                        {
                            Id = new Guid("6d0d2336-d191-4e40-abf8-27d081c464ce"),
                            Title = "creativity"
                        },
                        new
                        {
                            Id = new Guid("afc6d9d0-7c97-4f99-abf0-22a56ab4f454"),
                            Title = "school specialist’s assistance"
                        },
                        new
                        {
                            Id = new Guid("c8f290a1-ce07-4429-b0c4-90f6682c0941"),
                            Title = "other"
                        });
                });
            ...
            modelBuilder.Entity("Domain.UserCommunicationChannels.UserCommunicationChannel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsConfirmed = true,
                            LastEmailSentAt = new DateTime(2024, 5, 28, 23, 29, 15, 205, DateTimeKind.Utc).AddTicks(2006),
                        ...
                        new
                        {
                            ...
                            IsConfirmed = true,
                            LastEmailSentAt = new DateTime(2024, 5, 28, 23, 29, 15, 205, DateTimeKind.Utc).AddTicks(2040),
                        ...
                        new
                        {
                            ...
                            IsConfirmed = true,
                            LastEmailSentAt = new DateTime(2024, 5, 28, 23, 29, 15, 205, DateTimeKind.Utc).AddTicks(2043),
