...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20240319173647_CategoriesDataSeeding")]
    partial class CategoriesDataSeeding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Types.ObjectiveType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Duration = 8,
                            Eta = new DateTime(2024, 3, 21, 20, 36, 47, 29, DateTimeKind.Local).AddTicks(4468),
                        ...
                        new
                        {
                            Id = 2,
                            Duration = 8,
                            Eta = new DateTime(2024, 3, 21, 20, 36, 47, 29, DateTimeKind.Local).AddTicks(4488),
                            TypeTitle = "Group"
                        },
                        new
                        {
                            Id = 3,
                            Duration = 8,
                            Eta = new DateTime(2024, 3, 21, 20, 36, 47, 29, DateTimeKind.Local).AddTicks(4490),
                            TypeTitle = "Team"
                        });
                });
            ...
            modelBuilder.Entity("Domain.UserCommunicationChannels.UserCommunicationChannel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsConfirmed = false,
                            LastEmailSentAt = new DateTime(2024, 3, 19, 17, 36, 47, 30, DateTimeKind.Utc).AddTicks(7054),
                        ...
                        new
                        {
                            ...
                            IsConfirmed = false,
                            LastEmailSentAt = new DateTime(2024, 3, 19, 17, 36, 47, 30, DateTimeKind.Utc).AddTicks(7069),
                        ...
                        new
                        {
                            ...
                            IsConfirmed = false,
                            LastEmailSentAt = new DateTime(2024, 3, 19, 17, 36, 47, 30, DateTimeKind.Utc).AddTicks(7071),
            ...
            modelBuilder.Entity("ObjectiveUser", b =>
                {
                    ...
                    b.HasKey("ImplementorsId", "ObjectivesId");
            ...
            modelBuilder.Entity("Domain.Objectives.Objective", b =>
                {
                    b.HasOne("Domain.Users.UserDetails.User", "Creator")
                        .WithMany()
