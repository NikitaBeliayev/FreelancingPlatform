            ...
            modelBuilder.Entity("Domain.Types.ObjectiveType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Duration = 8,
                            Eta = new DateTime(2024, 3, 2, 1, 4, 26, 986, DateTimeKind.Local).AddTicks(4558),
                        ...
                        new
                        {
                            Id = 2,
                            Duration = 8,
                            Eta = new DateTime(2024, 3, 2, 1, 4, 26, 986, DateTimeKind.Local).AddTicks(4608),
                            TypeTitle = "Group"
                        },
                        new
                        {
                            Id = 3,
                            Duration = 8,
                            Eta = new DateTime(2024, 3, 2, 1, 4, 26, 986, DateTimeKind.Local).AddTicks(4612),
                            TypeTitle = "Team"
                        });
                });
