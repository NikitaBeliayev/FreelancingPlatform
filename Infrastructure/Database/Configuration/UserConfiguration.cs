    ...
    public class UserConfiguration : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.HasMany(e => e.Roles)
                ...
                {
                    new { RolesId = new Guid("00edafe3-b047-5980-d0fa-da10f400c1e5"), UsersId = new Guid("d3b8c19b-5d8b-492c-914a-b1b0fa5370ca")},
                    new { RolesId = new Guid("1d6026ce-0dac-13ea-8b72-95f02b7620a7"), UsersId = new Guid("88755139-42b8-415b-84df-04c639d9b47a")},
                    new { RolesId = new Guid("e438dde5-34d8-f76d-aecb-26a8d882d530"), UsersId = new Guid("3dc1e776-0e75-4577-ab99-ed85ba86fec5")}
                }));
            ...
            User testAdminUser = new User(
                ...
                Password.BuildPasswordWithoutValidation("9259de5682f80ba967a5263d420f44bb40a9267f9787d8034d597a69439e075f").Value!, 
                null!, null!, null!, null!);
            ...
            User testCustomerUser = new User(new Guid("88755139-42b8-415b-84df-04c639d9b47a"),
                ...
                Password.BuildPasswordWithoutValidation("afed0e5dd16c3aa13c0913df9557fe7ff05129a2eb4bf9c54b2c68545aec63b1").Value!, 
                null!, null!, null!, null!);
            ...
            User testImplementerUser = new User(new Guid("3dc1e776-0e75-4577-ab99-ed85ba86fec5"),
                ...
                Password.BuildPasswordWithoutValidation("d7b810563cf203ede3043fde799c9705b9ca66635c68cf0465ac3259200f59fe").Value!, 
                null!, null!, null!, null!);
